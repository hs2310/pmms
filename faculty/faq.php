						...
						function display()
						{
							...
							if (mysqli_num_rows($r) > 0)
							{
								...
								while($row = mysqli_fetch_assoc($r)) 
								{
									...
									<a class='card-link' data-toggle='collapse' data-parent='#accordion' href='#collapse".$x."'>
							...
							{
								echo "<div class='col-lg-12 text-center'><a href='#' class 'text-center'>No FAQ's to show</a></div>";
							}
						}
						display();
						mysqli_close($con);
